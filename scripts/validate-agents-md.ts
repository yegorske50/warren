...
const KNOWN_MISSING_PATHS = new Set<string>([
	...
	"test-results/junit.xml", // generated by `bun run test:ci`, gitignored
	"test-results", // parent directory, gitignored
	"coverage/lcov.info", // generated by `bun run test:coverage`, gitignored
	"coverage", // parent directory, gitignored
]);
